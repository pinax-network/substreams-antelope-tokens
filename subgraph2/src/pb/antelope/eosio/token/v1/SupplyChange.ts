...
export class SupplyChange {
  static encode(message: SupplyChange, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.string(message.maxSupply);

    writer.uint32(58);
    writer.string(message.supply);

    writer.uint32(64);
    writer.int64(message.supplyDelta);
  ...
  static decode(reader: Reader, length: i32): SupplyChange {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new SupplyChange();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          message.supplyDelta = reader.int64();
          break;
